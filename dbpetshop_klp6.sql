...
insert  into `transaksi`(`id_transaksi`,`tanggal`,`t_idbarang`,`qty`,`total`,`harga`) values (1,'2024-01-01','B001',2,170000,85000),(2,'2024-01-03','B003',1,135000,135000),(3,'2024-01-10','B002',2,120000,60000),(4,'2024-01-17','B006',3,42000,14000),(5,'2024-01-17','B004',2,24000,12000),(6,'2024-01-12','B001',2,170000,85000),(7,'2024-01-18','B004',2,24000,12000),(10,'2024-01-19','B001',2,170000,85000),(13,'2024-01-22','B001',2,170000,85000);
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `t_ai_transaksi` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `t_ai_transaksi` AFTER INSERT ON `transaksi` FOR EACH ROW BEGIN
